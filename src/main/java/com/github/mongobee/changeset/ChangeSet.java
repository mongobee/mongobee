...
public @interface ChangeSet {
  ...
  /**
   * Executes the change set on every mongobee's execution, even if it has been run before. Optional
   * (default is false)
   *
  ...
  //
  //  /**
  //   * Executes the change the first time it is seen and each time the change set has been
  // changed. <br/>
