...
public class Mongobee implements InitializingBean {
  ...
  private void initDependencies() {
    ...
    this.changeEntryDao = new ChangeEntryDao(DEFAULT_CHANGELOG_COLLECTION_NAME, DEFAULT_LOCK_COLLECTION_NAME);
  ...
  private void executeMigration() throws MongobeeException {
    ...
    for (Class<?> changelogClass : changeService.fetchChangeLogs()) {
      ...
      try {
        Object changelogInstance = changeService.createInstance(changelogClass);
  ...
  public Mongobee setChangelogCollectionName(String changelogCollectionName) {
    this.changeEntryDao.setChangelogCollectionName(changelogCollectionName);
    return this;
  }
  ...
  private void initialize() throws MongobeeConfigurationException, MongobeeConnectionException {
    ...
    this.changeEntryDao.connectMongoDb(mongoDatabase, db);
